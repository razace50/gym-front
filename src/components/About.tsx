...
const About = () => {
  return (
    <section className="bg-gray-50 text-gray-800 min-h-screen pt-20 px-4">
      {/* Hero Section */}
      <div className="max-w-5xl mx-auto text-center">
        <h1 className="text-4xl font-bold mb-4">About Our Gym</h1>
        <p className="text-lg text-gray-600 mb-6">
          At <span className="font-semibold">FlexFit Gym</span>, we believe in
      ...
      <div className="mt-16 max-w-5xl mx-auto text-center">
        <h2 className="text-3xl font-semibold mb-6">Why Choose FlexFit?</h2>
